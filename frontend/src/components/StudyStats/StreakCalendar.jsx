...
const StreakCalendar = ({
    ...
    const monthStats = useMemo(() => {
        ...
        const streakDays = currentStreak?.currentStreakDays ||
            currentMonthData.filter(day => day.hasStreak).length;
        const totalDays = currentMonthData.length;
        const longestStreak = currentStreak?.longestStreakDays ||
            Math.max(...currentMonthData.map(day => day.streakLength), 0);
            ...
            >
                ...
                <Box sx={{display: 'flex', flexDirection: {xs: 'column', md: 'row'}, gap: {xs: 2, md: 3}}}>
                    ...
                    <Box sx={{
                        ...
                        {[...Array(4)].map((_, index) => (
                            <Card key={index}
                                  sx={{borderRadius: 2, overflow: 'hidden', height: {xs: '90px', md: '80px'}}}>
                        ...
                        <Box>
                            ...
                            >
                                {['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'].map((day) => (
                                    <Typography
                                        key={day} // Full day names are unique
                                        variant="subtitle2"
                                        fontWeight="600"
                                        textAlign="center"
                                        color="text.primary"
