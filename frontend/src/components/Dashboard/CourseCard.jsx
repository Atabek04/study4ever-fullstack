...
import {getCourseImageUrl} from '../../utils/courseImageUtils';
...
const CourseCard = ({course}) => {
    ...
    const courseThumbnail = courseData.thumbnail || courseData.imageUrl || getCourseImageUrl(courseData) || fallbackImage;
